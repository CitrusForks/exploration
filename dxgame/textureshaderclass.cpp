...
bool TextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, wchar_t *vsFilename, char *vsFunctionName, wchar_t *psFilename, char *psFunctionName)
{
	HRESULT result;
	...
	// XXX then why the !@#$ is it defined separately in here?
