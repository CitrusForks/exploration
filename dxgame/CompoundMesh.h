...
public:
    ...
    bool render( ID3D11DeviceContext *deviceContext, VanillaShaderClass *shader, DirectX::CXMMATRIX worldMatrix, DirectX::CXMMATRIX viewMatrix, DirectX::CXMMATRIX projectionMatrix, DirectX::XMFLOAT4X4 *lightProjections, unsigned numShadows, CompoundMeshNode *node = nullptr );
    void release();
